        ...
        <div
          ...
          <div class="lg:col-star-1 lg:col-span-4">
            ...
            <h3
              ...
              Populer
              <span
                class="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-3 md:after:bottom-4 after:z-[-1]">Subjects</span>
            </h3>
          </div>
          ...
          <div
            ...
            <div>
              <a
                ...
                href="#">All Catagories <i class="icofont-long-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
              ...
              <div
                ...
                <ul class="flex flex-col gap-10px">
                  <li>
                    <a
                      href="#"
                      class="w-41px h-41px leading-41px bg-whiteColor text-darkdeep4 hover:bg-primaryColor hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor dark:hover:text-whiteColor text-base rounded text-center"><i class="icofont-facebook"></i></a>
                  </li>
                  <li>
                    <a
                      href="#"
                      class="w-41px h-41px leading-41px bg-whiteColor text-darkdeep4 hover:bg-primaryColor hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor dark:hover:text-whiteColor text-base rounded text-center"><i class="icofont-twitter"></i></a>
                  </li>
                  <li>
                    <a
                      href="#"
                      class="w-41px h-41px leading-41px bg-whiteColor text-darkdeep4 hover:bg-primaryColor hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor dark:hover:text-whiteColor text-base rounded text-center"><i class="icofont-instagram"></i></a>
                  </li>
                  <li>
                    <a
                      href="#"
                      class="w-41px h-41px leading-41px bg-whiteColor text-darkdeep4 hover:bg-primaryColor hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor dark:hover:text-whiteColor text-base rounded text-center"><i class="icofont-youtube-play"></i></a>
                  </li>
                </ul>
              </div>
            </div>
