    ...
    <div class="container mx-auto px-4 py-16 text-center">
      ...
      ?>
        ...
        <a href="pages/auth/register.php"
          class="inline-block bg-gradient-to-r from-[#000957] to-[#344CB7] text-white px-8 py-3 rounded-full font-medium hover:bg-gradient-to-r hover:from-[#344CB7] hover:to-[#577BC1] transform hover:-translate-y-0.5 transition">
          Start Today
        </a>
      <?php
      } else {
      ...
      <?php
        if ($user instanceof Student) {
          ...
          echo '<a href="pages/student/myCourses.php"
          <a href="#" class="inline-block bg-gradient-to-r from-[#000957] to-[#344CB7] text-white px-8 py-3 rounded-full font-medium hover:bg-gradient-to-r hover:from-[#344CB7] hover:to-[#577BC1] transform hover:-translate-y-0.5 transition">
  My Courses
</a>
        </a>';
        } elseif ($user instanceof Teacher) {
