...
<!-- Mirrored from html.themewin.com/edurcok-preview-tailwind/edurock/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 03:18:39 GMT -->
<head>
    <meta charset="UTF-8" >
  ...
  >
    ...
    <header>
      ...
      >
        <nav
          class="lg:container 3xl:container2-lg 4xl:container mx-auto relative"
        >
          <!-- navbar top -->
          <div
            class="hidden lg:grid grid-cols-12 py-5 px-15px items-center gap-30px border-b border-borderColor dark:border-borderColor-dark -mx-15px"
          >
            <div class="col-start-1 col-span-3">
              <ul class="flex items-center nav-list">
                <li class="relative">
                  <button
                    class="text-contentColor dark:text-contentColor-dark pr-10px flex items-center"
                  >
                    <img
                      src="assets/images/icon/flag1.webp"
                      alt=""
                      class="w-6 h-6 mr-1 rounded-lg2"
                    >
                    ENG
                  ...
                  >
                    <div
                      class="shadow-dropdown3 max-w-dropdown2 w-2000 rounded-standard bg-white dark:bg-whiteColor-dark"
                    >
                      <ul>
                        <li>
                          <a
                            href="#"
                            class="flex items-center text-size-13 text-blackColor p-10px transition duration-300 hover:bg-darkdeep4 hover:text-whiteColor dark:text-blackColor-dark dark:hover:text-whiteColor-dark dark:hover:bg-darkdeep4"
                            ><img
                              src="assets/images/icon/flag2.webp"
                              alt=""
                              class="w-18px h-18px rounded-lg mr-10px"
                            >FR
                          </a>
                        </li>
                        <li>
                ...
                <li class="relative">
                  <button
                    class="text-contentColor dark:text-contentColor-dark pl-10px flex items-center"
                  >
                    USD
                    <i class="icofont-rounded-down"></i>
                  </button>
                    ...
                    >
                      <ul>
                        <li>
                          <a
                            href="#"
                            class="w-full text-size-13 text-blackColor p-10px pl-5 transition duration-300 hover:bg-darkdeep4 hover:text-whiteColor dark:text-blackColor-dark dark:hover:text-whiteColor-dark dark:hover:bg-darkdeep4"
                            >FR
                          </a>
                        </li>
                        <li>
            ...
            <div class="col-start-4 col-span-6">
              <form>
                <div
                  class="text-blackColor dark:text-blackColor-dark py-2 pl-15px border border-borderColor dark:border-borderColor-dark relative rounded-full"
                >
                  <input
                    type="text"
                    placeholder="Search Course"
                    class="w-full focus:outline-none bg-transparent placeholder:text-darkdeep4"
                  >
                  <button
                    type="submit"
            ...
            <div class="col-start-10 col-span-3">
              <ul class="relative nav-list flex justify-end items-center">
                <li class="px-5 lg:px-10px 2xl:px-5 group">
                  ...
                  <!-- dropdown menu -->
                  <div
                    class="dropdown absolute right-0 lg:right-8 translate-y-10 z-medium hidden opacity-0 pt-5px"
                    style="transition: 0.3s"
                  >
                    <div
          ...
          <div class="py-15px lg:py-0 px-15px">
            <div
              class="grid grid-cols-2 lg:grid-cols-12 items-center gap-15px -mx-15px"
            >
              <!-- navbar left -->
    ...
    <main class="bg-transparent">
      ...
      <section>
        <!-- banner section -->
        <div
          class="hero bg-lightGrey11 dark:bg-lightGrey11-dark relative z-0 overflow-hidden py-50px md:py-100px lg:pb-150px lg:pt-100px 2xl:pb-40 2xl:pt-30"
        >
          <!-- animated icons -->
          <div>
            <img
          ...
          <div class="container 2xl:container-secondary-md relative">
            <div class="grid grid-cols-1 lg:grid-cols-12 items-center gap-30px">
              <!-- banner Left -->
              <div data-aos="fade-up" class="lg:col-start-1 lg:col-span-7">
                <div class="3xl:pr-135px">
                  ...
                  <h1
                    class="text-size-35 md:text-size-65 lg:text-5xl 2xl:text-size-90 leading-42px md:leading-18 lg:leading-15 2xl:leading-24 text-blackColor dark:text-blackColor-dark md:tracking-half lg:tracking-normal 2xl:tracking-half font-bold mb-15px"
                  >
                    Your Awesome
                    <span class="text-secondaryColor">Online</span> Course
                  </h1>
                  <p
              ...
              <!-- banner right -->
              <div data-aos="fade-up" class="lg:col-start-8 lg:col-span-5">
                <div class="relative">
                  <img
                    src="assets/images/herobanner/herobanner__video.jpg"
                    alt=""
                    class="w-full rounded-lg2"
                  >
      ...
      <div data-aos="fade-up">
        <div
          class="container-fluid py-10 px-30px 2xl:px-50px 3xl:px-150px bg-borderColor dark:bg-borderColor-dark overflow-x-hidden"
        >
          <div class="flex animate-marquee play-state gap-5">
            <!--  subject cards  -->
