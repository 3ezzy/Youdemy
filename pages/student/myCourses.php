            ...
            <ul class="hidden md:flex items-center space-x-6">
              ...
              <li class="relative">
                ...
                <div id="dropdownMenu"
                  ...
                  <a href="#"
                    class="block px-4 py-2 text-sm text-gray-800 font-medium hover:bg-[#344CB7] hover:text-white">My
                    Courses</a>
  ...
  <main class="flex-1 mx-auto px-6 pt-16 max-w-6xl">
    <?php if (!$user->isSuspended()) { ?>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 pb-8 bg-[#344CB7] border-b border-gray-100">
          <h1 class="text-xl font-semibold text-white pt-4">My Enrolled Courses</h1>
        ...
        <div class=" p-6">
              <div class=" mb-6">
                ...
                <i class="fas fa-layer-group bg-gradient-to-r from-[#344CB7] to-[#577BC1] bg-clip-text text-transparent mr-2"></i>
                  Total Courses Enrolled : <span class="font-semibold"><?= count($enrolledCourses) ?></span>
                </p>
              </div>
              <div class="overflow-x-auto">
                <table class="min-w-full w-full table-auto">
                  <thead class="bg-[#344CB7] text-white">
                    <tr class="">
