...
<head>
  ...
  <title>Youdemy - Contact Us</title>
  ...
  <main class="flex-grow">
    ...
    <section class="pt-20 pb-12 bg-gradient-to-b from-[#344CB7] to-white">
      <div class="container mx-auto px-4 text-center">
        <span class="text-5xl mb-6 bg-gradient-to-r from-[#000957] to-[#344CB7] text-transparent bg-clip-text">
    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div class="space-y-8">
            <!-- Contact Information -->
            <div class="bg-[#344CB7]/10 p-8 rounded-xl">
              <h2 class="text-2xl font-bold text-gray-900 mb-6">Contact Information</h2>

              <div class="space-y-6">
                <!-- Location -->
                <div class="flex items-start space-x-4">
                  <div class="w-10 h-10 bg-[#344CB7]/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <i class="fas fa-map-marker-alt text-[#344CB7]"></i>
                  </div>
                  <div>
                    <h3 class="font-semibold text-gray-900">Our Location</h3>
                    <p class="text-gray-600">123 Admin Street<br>Safi, Morocco, NR 12345</p>
                  </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                  <div class="w-10 h-10 bg-[#344CB7]/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <i class="fas fa-phone text-[#344CB7]"></i>
                  </div>
                  <div>
                ...
                <div class="flex items-start space-x-4">
                  <div class="w-10 h-10 bg-[#344CB7]/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <i class="fas fa-envelope text-[#344CB7]"></i>
                  </div>
                  <div>
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <form class="space-y-6">
              ...
              <button type="submit"
                class="w-full bg-[#344CB7] text-white px-6 py-3 rounded-full hover:bg-[#577BC1] transform hover:-translate-y-0.5 transition">
                Send Message
              </button>
            </form>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        ...
        <div class="flex justify-center">
          <ul class="space-y-1 text-center">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition text-sm">Contact</a>
            </li>
          </ul>
        </div>
