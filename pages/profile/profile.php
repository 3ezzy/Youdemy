            ...
            <ul class="hidden md:flex items-center space-x-6">
              ...
              <li class="relative">
                ...
                <div id="dropdownMenu"
                  ...
                  <a href="#"
                    class="block px-4 py-2 text-sm text-gray-800 font-medium hover:bg-[#344CB7] hover:text-white">Profile</a>
                  <?php if ($user instanceof Admin) { ?>
                    <a href="../admin/adminDashboard.php"
                      class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#344CB7] hover:text-white">Admin
                      Dashboard</a>
                  <?php } elseif ($user instanceof Teacher) { ?>
                    <a href="../teacher/teacherDashboard.php"
                      class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#344CB7] hover:text-white">Teacher
                      Dashboard</a>
                  <?php } elseif ($user instanceof Student) { ?>
                    <a href="../admin/adminDashboard.php"
                      class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#344CB7] hover:text-white">My
                      Courses</a>
                  <?php } ?>
  ...
  <main class="py-12 px-4">
    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="px-6 py-4 bg-[#344CB7] border-b border-gray-100">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="pt-4 border-t border-gray-100">
            <button id="updateProfileBtn"
              class="bg-[#344CB7] text-white px-6 py-3 rounded-full hover:bg-[#577BC1] transform hover:-translate-y-0.5 transition">
              Update Profile
            </button>
          </div>
        </div>
