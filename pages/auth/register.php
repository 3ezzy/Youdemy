      ...
      <div class="max-w-md mx-auto">
        <div class="bg-white rounded-xl shadow-sm p-8">
          <div class="text-center mb-8">
            <div class="w-20 h-20 bg-[#344CB7] rounded-full flex items-center justify-center mx-auto mb-6">
              <i class="fas fa-user-plus text-3xl text-white"></i>
            </div>
            <h2 class="text-2xl font-bold text-gray-900">Create Account</h2>
            <p class="text-gray-600 mt-2">Already have an account?
              <a href="login.php" class="text-[#344CB7] hover:text-[#577BC1]">Sign in here</a>
            </p>
          </div>
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-2 gap-4">
                <label class="relative cursor-pointer">
                  ...
                  <div
                    class="w-full p-4 border rounded-lg peer-checked:border-[#344CB7] peer-checked:bg-[#344CB7]/10 hover:border-[#577BC1] transition-colors text-center">
                    <i class="fas fa-user-graduate mb-2 text-xl text-[#344CB7]"></i>
                ...
                <label class="relative cursor-pointer">
                  ...
                  <div
                    class="w-full p-4 border rounded-lg peer-checked:border-[#344CB7] peer-checked:bg-[#344CB7]/10 hover:border-[#577BC1] transition-colors text-center">
                    <i class="fas fa-chalkboard-teacher mb-2 text-xl text-[#344CB7]"></i>
